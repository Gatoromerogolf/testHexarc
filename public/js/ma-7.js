...
function obtenerValoresSeleccionados() {
  respuestas = [];
  const grupos = ["A-7-1", "A-7-2", "A-7-3", "A-7-4", "A-7-5"];
...
// Si no hay faltantes sigue adelante:::::::::::::::::::::::::
    if (!(filasFaltantes.length > 0)) {
      ...
      localStorage.setItem("maximo-7", JSON.stringify(maximo));
      localStorage.setItem("valores-7", JSON.stringify(valores));
      localStorage.setItem("porciento-7", JSON.stringify(porcientoFormateado));
