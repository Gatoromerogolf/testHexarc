...
async function actualizarHTML(respuestas) {
    ...
    document.getElementById("porcentajeObtenido").innerHTML =
...
function armarDetalleGeneral(
    ...
    for (const pregunta of preguntasSeccion) {
        ...
        const registroRespuestasSeccion = respuestas.find(
            (item) => item.seccion === pregunta.Seccion
        );
        ...
        if (pregunta.tipo > 50) {
            ...
            console.log(
                ...
                }, valorRespuesta ${valorRespuesta}, pregunta.Numero ${pregunta.Numero
                }, resta: ${[pregunta.Numero - 1]}`
            );
        ...
        if (pregunta.tipo > 40 && pregunta.tipo < 50) {
            ...
            console.log(
                `registro Respuestas seccion  ${registroRespuestasSeccion.respuesta}`
            );
            console.log(
                `registro Respuestas seccion [6] ${registroRespuestasSeccion.respuesta[6]}`
            );
        ...
        //     imagen.src = "../img/advertencia-rojo.png";
        //     celdaComenta.appendChild(imagen);
        // }
        ...
        //     imagen.src = "../img/alerta-rojo.png";
        //     celdaComenta.appendChild(imagen);
        // }
